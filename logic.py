...
if __name__ == '__main__':
	...
	#print('метод: get_pagination_links (на примере одной категории), тип:', type(logic.get_pagination_links(categories_dict.get(categories[0]))), logic.get_pagination_links(categories_dict.get(categories[0]))) #список кусков-страниц одной категории
